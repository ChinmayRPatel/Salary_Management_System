        ...
        <div class="top-bar">
            <div class="container-fluid clearfix">
                ...
                <div class="right-content float-right">
                    <ul>
                        <li>Made By  Team Chinmay Patel</li>
                    </ul>
                </div><!-- /.left-content -->
            </div><!-- /.container-fluid -->
        </div><!-- /.top-bar -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12 d-flex">
                        <div class="footer-widget my-auto">
                            ...
                            <div class="social">
                                <a href="https://chinmaypatel.tech/"><i class="fa fa-twitter"></i></a>
                                <a href="https://chinmaypatel.tech/"><i class="fa fa-send"></i></a>
                                <a href="https://www.linkedin.com/in/patel-chinmay-1a5349219/?trk=opento_sprofile_goalscard"><i class="fa fa-linkedin"></i></a>
                                <a href="https://github.com/ChinmayRPatel?tab=repositories"><i class="fa fa-github"></i></a>
                            </div><!-- /.social -->
                        </div><!-- /.footer-widget -->
                    </div><!-- /.col-lg-5 -->
                </div><!-- /.row -->
