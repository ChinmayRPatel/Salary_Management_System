...
<div class="page-wrapper">
        ...
        <div class="top-bar">
            <div class="container-fluid clearfix">
                ...
                <div class="right-content float-right">
                          ...
                          <a style="color:white" href="topnotch" target="_blank">Made By Team Chinmay Patel</a>
    ...
    <div id="minimal-bootstrap-carousel" class="carousel slide carousel-fade slider-content-style slider-home-one">
        ...
        <div class="carousel-inner">
                    ...
                    <div class="container">
                        <div class="box valign-middle">
                            <div class="content text-left">
                                <h3 data-animation="animated fadeInUp">Payroll <br> Solutions</h3>
                                <p data-animation="animated fadeInDown">to take your business further</p>
            ...
            <div class="carousel-item slide-2" style="background-image: url(images/banner-1-2.jpg);">
                <div class="carousel-caption">
                    <div class="container">
                        <div class="box valign-middle">
                            <div class="content text-left">
            ...
            <div class="carousel-item slide-3" style="background-image: url(images/banner-1-3.jpg);">
                <div class="carousel-caption">
                    <div class="container">
                        <div class="box valign-middle">
                            <div class="content text-left">
    ...
    <section class="service-style-one sec-pad-top">
        <div class="container">
            ...
            <ul class="nav nav-tabs tab-title clearfix" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#hiring" role="tab" data-toggle="tab">
                        <span class="icon-box">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade show active" id="payroll">
                    <div class="single-tab-content">
                        ...
                        <div class="text-box">
                            <h3>Payroll</h3>
                            <p>Save time and improve payroll accuracy with the latest in time and attendance software. However you prefer to track employee time, we have flexible options to fit your business.</p>
                ...
                <div role="tabpanel" class="tab-pane fade" id="hiring">
                    <div class="single-tab-content">
                        <div class="icon-box">
                            <i class="payonline-icon-users"></i>
                        </div><!-- /.icon-box -->
    ...
    <section class="get-apps-style-one">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex">
                    <div class="get-apps-style-one-content my-auto">
                        <div class="sec-title">
                            <span>payonline app</span>
                            <h2>Making life easier for our all <br> employees</h2>
                        </div><!-- /.sec-title -->
                        <p>Get access to your HR data anytime, anywhere, with the Payonline app. There are many variations of passages of lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
                        <div class="btn-box">
                            <a href="#" class="thm-btn style-two"><i class="fa fa-play"></i> Coming Soon</a><!--
                            --><a href="#" class="thm-btn"><i class="fa fa-apple"></i> Coming Soon</a>
                            <span class="btn-tag-line">Try our application <i class="payonline-icon-share"></i></span>
                        </div><!-- /.btn-box -->
                    </div><!-- /.get-apps-style-one-content -->
                </div><!-- /.col-lg-6 -->
                <div class="col-lg-6">
                    <img src="images/mockup-11-1.png" class="featured-image" alt="Awesome Image">
                </div><!-- /.col-lg-6 -->
            </div><!-- /.row -->
        </div><!-- /.container -->
    </section><!-- /.get-apps-style-one -->
