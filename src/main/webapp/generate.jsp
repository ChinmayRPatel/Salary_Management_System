...
<div class="page-wrapper">
    ...
    <footer class="site-footer">
        ...
        <div class="bottom-footer">
            <div class="container">
                <p>&copy; Copyright <script>document.write(new Date().getFullYear())</script> by <a href="" target="_blank">Team chinmay patel</a></p>
            </div><!-- /.container -->
        </div><!-- /.bottom-footer -->
    </footer><!-- /.site-footer -->
...
<script type="text/javascript">
    ...
    var message = "Hii " + name + ",\nYour PaySlip for the month of " + month + " is " + result + ".\nFor details, contact the branch office.\nThank you.";

    function myPrint(divId) {
        var printWindow = window.open('', '', 'height=600,width=800');
        var content = document.getElementById(divId).innerHTML;
        printWindow.document.write('<html><head><title>Print</title>');
        printWindow.document.write('<link rel="stylesheet" type="text/css" href="css/style.css">'); // Include your styles
    ...
    function sendEmail() {
        ...
        $.ajax({
            type: "POST",
            url: "/sendEmail",  // URL of your Spring Boot API
